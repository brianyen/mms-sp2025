...
void updatePID() {
	...
	float leftSetting = distanceCorrection - angleCorrection;
	float rightSetting = distanceCorrection + angleCorrection;

	float leftPWM = leftSetting * PWM_MAX;
	float rightPWM = rightSetting * PWM_MAX;
